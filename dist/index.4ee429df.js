...
_coreDefault.default.use([_core.Navigation, _core.Pagination]);
var swiper = new _swiperDefault.default(".mySwiper", {
    slidesPerView: 2,
    spaceBetween: 10,
    slidesPerGroup: 2,
    loop: true,
...
},{"swiper":"GxxLH","swiper/swiper-bundle.css":"FI370","swiper/core":"GxxLH","@parcel/transformer-js/src/esmodule-helpers.js":"367CR"}],"GxxLH":[function(require,module,exports) {
/**
 * Swiper 6.7.0
...
var Swiper = /*#__PURE__*/ function() {
    function Swiper1() {
        ...
        if (params.el && _dom.default(params.el).length > 1) {
            var swipers = [];
            _dom.default(params.el).each(function(containerEl) {
    ...
    _proto.mount = function mount(el) {
        ...
        var $el = _dom.default(el || swiper.params.el);
        el = $el[0];
        if (!el) return false;
        el.swiper = swiper;
        var getWrapper = function getWrapper1() {
            if (el && el.shadowRoot && el.shadowRoot.querySelector) {
                var res = _dom.default(el.shadowRoot.querySelector("." + swiper.params.wrapperClass)); // Children needs to return slot items
        ...
        if ($wrapperEl.length === 0 && swiper.params.createElements) {
            ...
            $wrapperEl = _dom.default(wrapper);
...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define([
        'exports'
    ], factory) : (global = global || self, factory(global.ssrWindow = {
    }));
...
function updateSlidesProgress(translate) {
    ...
    swiper.visibleSlides = _dom.default(swiper.visibleSlides);
}
...
function updateClickedSlide(e) {
    var swiper = this;
    var params = swiper.params;
    var slide = _dom.default(e.target).closest("." + params.slideClass)[0];
    ...
    if (slide && slideFound) {
        ...
        if (swiper.virtual && swiper.params.virtual.enabled) swiper.clickedIndex = parseInt(_dom.default(slide).attr('data-swiper-slide-index'), 10);
...
function slideToClickedSlide() {
    ...
    if (params.loop) {
        ...
        realIndex = parseInt(_dom.default(swiper.clickedSlide).attr('data-swiper-slide-index'), 10);
        if (params.centeredSlides) {
...
function loopCreate() {
    ...
    if (params.loopFillGroupWithBlank) {
        ...
        if (blankSlidesNum !== params.slidesPerGroup) {
            for(var i = 0; i < blankSlidesNum; i += 1){
                var blankNode = _dom.default(document.createElement('div')).addClass(params.slideClass + " " + params.slideBlankClass);
    ...
    slides.each(function(el, index) {
        var slide = _dom.default(el);
        if (index < swiper.loopedSlides) appendSlides.push(el);
        if (index < slides.length && index >= slides.length - swiper.loopedSlides) prependSlides.push(el);
        slide.attr('data-swiper-slide-index', index);
    });
    for(var _i = 0; _i < appendSlides.length; _i += 1)$wrapperEl.append(_dom.default(appendSlides[_i].cloneNode(true)).addClass(params.slideDuplicateClass));
    for(var _i2 = prependSlides.length - 1; _i2 >= 0; _i2 -= 1)$wrapperEl.prepend(_dom.default(prependSlides[_i2].cloneNode(true)).addClass(params.slideDuplicateClass));
}
...
function attachEvents() {
    ...
    if (params.cssMode) swiper.onScroll = _onScroll.default.bind(swiper);
    ...
    if (params.cssMode) wrapperEl.addEventListener('scroll', swiper.onScroll);
     // Resize handler
    if (params.updateOnWindowResize) swiper.on(device.ios || device.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', _onResize.default, true);
    else swiper.on('observerUpdate', _onResize.default, true);
}
...
function onTouchStart(event) {
    ...
    var $targetEl = _dom.default(e.target);
    ...
    if (swipingClassHasValue && e.target && e.target.shadowRoot && event.path && event.path[0]) $targetEl = _dom.default(event.path[0]);
    ...
    if (e.type !== 'touchstart') {
        ...
        if (document.activeElement && _dom.default(document.activeElement).is(data.formElements) && document.activeElement !== $targetEl[0]) document.activeElement.blur();
...
function onTouchMove(event) {
    ...
    if (data.isTouchEvent && document.activeElement) {
        if (e.target === document.activeElement && _dom.default(e.target).is(data.formElements)) {
            data.isMoved = true;
            swiper.allowClick = false;
            return;
        }
...
function onScroll() {
    ...
    if (swiper.isHorizontal()) {
     ...
     // eslint-disable-next-line
    if (swiper.translate === -0.0) swiper.translate = 0;
    swiper.updateActiveIndex();
    swiper.updateSlidesClasses();
    var newProgress;
    var translatesDiff = swiper.maxTranslate() - swiper.minTranslate();
...
function getBreakpoint(breakpoints, base, containerEl) {
    ...
    for(var i = 0; i < points.length; i += 1){
        ...
        if (value <= currentWidth) breakpoint = point;
    }
...
function loadImage(imageEl, src, srcset, sizes, checkForComplete, callback) {
    ...
    var isPicture = _dom.default(imageEl).parent('picture')[0];
...
var Virtual = {
    ...
    renderSlide: function renderSlide(slide, index) {
        ...
        var $slideEl = params.renderSlide ? _dom.default(params.renderSlide.call(swiper, slide, index)) : _dom.default("<div class=\"" + swiper.params.slideClass + "\" data-swiper-slide-index=\"" + index + "\">" + slide + "</div>");
...
var Keyboard = {
    ...
    enable: function enable() {
        ...
        _dom.default(document).on('keydown', swiper.keyboard.handle);
    ...
    disable: function disable() {
        ...
        var document = _ssrWindow.getDocument();
        if (!swiper.keyboard.enabled) return;
        _dom.default(document).off('keydown', swiper.keyboard.handle);
...
var Mousewheel = {
    ...
    handle: function handle(event1) {
        ...
        if (swiper.params.mousewheel.eventsTarget !== 'container') target = _dom.default(swiper.params.mousewheel.eventsTarget);
...
var Navigation = {
    ...
    init: function init() {
        ...
        var $prevEl;
        if (params.nextEl) {
            $nextEl = _dom.default(params.nextEl);
        ...
        if (params.prevEl) {
            $prevEl = _dom.default(params.prevEl);
...
var _default = {
    ...
    on: {
        ...
        click: function click(swiper, e) {
            ...
            if (swiper.params.navigation.hideOnClick && !_dom.default(targetEl).is($prevEl) && !_dom.default(targetEl).is($nextEl)) {
...
var Pagination = {
    update: function update() {
        ...
        if (params.type === 'bullets' && swiper.pagination.bullets && swiper.pagination.bullets.length > 0) {
            ...
            if ($el.length > 1) bullets.each(function(bullet) {
                var $bullet = _dom.default(bullet);
    ...
    init: function init() {
        ...
        if (params.clickable) $el.on('click', _utils.classesToSelector(params.bulletClass), function onClick(e) {
            e.preventDefault();
            var index = _dom.default(this).index() * swiper.params.slidesPerGroup;
...
var _default = {
    ...
    on: {
        ...
        click: function click(swiper, e) {
            var targetEl = e.target;
            if (swiper.params.pagination.el && swiper.params.pagination.hideOnClick && swiper.pagination.$el.length > 0 && !_dom.default(targetEl).hasClass(swiper.params.pagination.bulletClass)) {
...
var Scrollbar = {
    ...
    init: function init() {
        ...
        if ($dragEl.length === 0) {
            $dragEl = _dom.default("<div class=\"" + swiper.params.scrollbar.dragClass + "\"></div>");
            $el.append($dragEl);
        }
        _utils.extend(scrollbar, {
            $el: $el,
...
var Parallax = {
    ...
    setTranslate: function setTranslate() {
        ...
        slides.each(function(slideEl, slideIndex) {
            ...
            _dom.default(slideEl).find('[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]').each(function(el) {
    ...
    setTransition: function setTransition(duration) {
        ...
        $el.find('[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]').each(function(parallaxEl) {
            var $parallaxEl = _dom.default(parallaxEl);
...
var Zoom = {
    ...
    onGestureStart: function onGestureStart(e) {
        ...
        if (!gesture.$slideEl || !gesture.$slideEl.length) {
            gesture.$slideEl = _dom.default(e.target).closest("." + swiper.params.slideClass);
...
var Lazy = {
    loadInSlide: function loadInSlide(index, loadInDuplicate) {
        ...
        $images.each(function(imageEl) {
            var $imageEl = _dom.default(imageEl);
            ...
            swiper.loadImage($imageEl[0], src || background, srcset, sizes, false, function() {
                ...
                if (background) {
                    ...
                    if ($pictureEl.length) $pictureEl.children('source').each(function(sourceEl) {
                        var $source = _dom.default(sourceEl);
    ...
    load: function load() {
        ...
        function slideIndex(slideEl) {
            if (isVirtual) return _dom.default(slideEl).attr('data-swiper-slide-index');
            return _dom.default(slideEl).index();
        }
        ...
        if (swiper.params.watchSlidesVisibility) $wrapperEl.children("." + swiperParams.slideVisibleClass).each(function(slideEl) {
            var index = isVirtual ? _dom.default(slideEl).attr('data-swiper-slide-index') : _dom.default(slideEl).index();
    ...
    checkInViewOnLoad: function checkInViewOnLoad() {
        ...
        var swiper = this;
        if (!swiper || swiper.destroyed) return;
        var $scrollElement = swiper.params.lazy.scrollingElement ? _dom.default(swiper.params.lazy.scrollingElement) : _dom.default(window);
...
var _default = {
    ...
    on: {
        ...
        slideChange: function slideChange(swiper) {
            if (swiper.params.lazy.enabled && swiper.params.cssMode) swiper.lazy.load();
        }
    }
};
exports.default = _default;
...
var A11y = {
    ...
    updatePagination: function updatePagination() {
        ...
        if (swiper.pagination && swiper.params.pagination.clickable && swiper.pagination.bullets && swiper.pagination.bullets.length) swiper.pagination.bullets.each(function(bulletEl) {
            var $bulletEl = _dom.default(bulletEl);
    ...
    init: function init() {
        ...
        if (params.itemRoleDescriptionMessage) swiper.a11y.addElRoleDescription(_dom.default(swiper.slides), params.itemRoleDescriptionMessage);
        swiper.a11y.addElRole(_dom.default(swiper.slides), params.slideRole);
        swiper.slides.each(function(slideEl) {
            var $slideEl = _dom.default(slideEl);
    ...
    create: function create() {
        ...
        _utils.bindModuleMethods(swiper, {
            a11y: _extends({
                ...
                liveRegion: _dom.default("<span class=\"" + swiper.params.a11y.notificationClass + "\" aria-live=\"assertive\" aria-atomic=\"true\"></span>")
            })
        });
    },
    on: {
...
var HashNavigation = {
    ...
    init: function init() {
        ...
        if (swiper.params.hashNavigation.watchState) _dom.default(window).on('hashchange', swiper.hashNavigation.onHashCange);
    },
    destroy: function destroy() {
        var swiper = this;
        var window = _ssrWindow.getWindow();
        if (swiper.params.hashNavigation.watchState) _dom.default(window).off('hashchange', swiper.hashNavigation.onHashCange);
    }
};
var _default = {
        ...
        if (params.shadow) {
            if (isHorizontal) {
                ...
                if ($cubeShadowEl.length === 0) {
                    $cubeShadowEl = _dom.default('<div class="swiper-cube-shadow"></div>');
        ...
        for(var i = 0; i < slides.length; i += 1){
            ...
            if (params.slideShadows) {
                ...
                if (shadowBefore.length === 0) {
                    shadowBefore = _dom.default("<div class=\"swiper-slide-shadow-" + (isHorizontal ? 'left' : 'top') + "\"></div>");
                    $slideEl.append(shadowBefore);
                }
                if (shadowAfter.length === 0) {
                    shadowAfter = _dom.default("<div class=\"swiper-slide-shadow-" + (isHorizontal ? 'right' : 'bottom') + "\"></div>");
    ...
    setTranslate: function setTranslate() {
        ...
        for(var i = 0; i < slides.length; i += 1){
            ...
            if (swiper.params.flipEffect.slideShadows) {
                ...
                if (shadowBefore.length === 0) {
                    shadowBefore = _dom.default("<div class=\"swiper-slide-shadow-" + (swiper.isHorizontal() ? 'left' : 'top') + "\"></div>");
                    $slideEl.append(shadowBefore);
                }
                if (shadowAfter.length === 0) {
                    shadowAfter = _dom.default("<div class=\"swiper-slide-shadow-" + (swiper.isHorizontal() ? 'right' : 'bottom') + "\"></div>");
                    $slideEl.append(shadowAfter);
                }
                if (shadowBefore.length) shadowBefore[0].style.opacity = Math.max(-progress, 0);
                if (shadowAfter.length) shadowAfter[0].style.opacity = Math.max(progress, 0);
        ...
        for(var i = 0, length = slides.length; i < length; i += 1){
            ...
            if (params.slideShadows) {
                ...
                if ($shadowBeforeEl.length === 0) {
                    $shadowBeforeEl = _dom.default("<div class=\"swiper-slide-shadow-" + (isHorizontal ? 'left' : 'top') + "\"></div>");
                    $slideEl.append($shadowBeforeEl);
                }
                if ($shadowAfterEl.length === 0) {
                    $shadowAfterEl = _dom.default("<div class=\"swiper-slide-shadow-" + (isHorizontal ? 'right' : 'bottom') + "\"></div>");
...
var Thumbs = {
    ...
    onThumbClick: function onThumbClick() {
        ...
        if (clickedSlide && _dom.default(clickedSlide).hasClass(swiper.params.thumbs.slideThumbActiveClass)) return;
        if (typeof clickedIndex === 'undefined' || clickedIndex === null) return;
        var slideToIndex;
        if (thumbsSwiper.params.loop) slideToIndex = parseInt(_dom.default(thumbsSwiper.clickedSlide).attr('data-swiper-slide-index'), 10);
...
},{"../../utils/utils":"3xqzY","../../utils/dom":"36a0X"}],"FI370":[function() {},{}],"367CR":[function(require,module,exports) {
...
},{}]},["1XQsC","SXDIM"], "SXDIM", "parcelRequireb7ae")
